...
if __name__ == "__main__":
    ...
    for i in range(1, 3):
        path_list.append(path + "/type{}.csv".format(i))

    # for i in range(1, 3):
    #     path_list.append(path + "/fragment{}.csv".format(i))
    ...
    for i in range(1, 3):
        now_danmu_list.append(path + "/type{}.csv".format(i))

    # for i in range(1, 3):
    #     now_danmu_list.append(path + "/fragment{}.csv".format(i))
